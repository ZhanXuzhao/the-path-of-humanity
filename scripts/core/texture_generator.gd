...
static func _load_buildings() -> Dictionary:
	...
	bld["wood_wall"]        = _load_svg(BUILDINGS_PATH + "wall.svg")
	bld["wood_door"]        = _load_svg(BUILDINGS_PATH + "wall.svg")
	bld["stone_wall"]       = _load_svg(BUILDINGS_PATH + "wall.svg")
	bld["stone_door"]       = _load_svg(BUILDINGS_PATH + "wall.svg")
	bld["iron_wall"]        = _load_svg(BUILDINGS_PATH + "wall.svg")
	bld["iron_door"]        = _load_svg(BUILDINGS_PATH + "wall.svg")
